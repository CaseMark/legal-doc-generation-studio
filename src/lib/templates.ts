    ...
    },
    {
      ...
      variables: [
        ...
        },
        {
          ...
          type: 'select',
          required: true,
          description: 'State where employment laws apply',
          options: [
      ...
      variables: [
        {
          ...
          description: 'Describe why confidential information will be shared'
        }
      ]
    },
    {
      ...
      variables: [
        ...
        },
        {
          ...
          defaultValue: 3,
          placeholder: '3',
          description: 'How long information must remain confidential after agreement ends'
        },
        {
          id: 'governing_state',
    ...
    },
    {
      ...
      variables: [
        ...
        },
        {
          ...
          description: 'Specific items or outcomes to be delivered'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      variables: [
        ...
        },
        {
          ...
          type: 'date',
          required: false,
          description: 'Leave blank for ongoing engagement'
        },
        {
      ...
      variables: [
        {
          ...
          required: true,
          options: [
            { value: 'time_materials', label: 'Time and Materials' },
      ...
      variables: [
        {
          ...
          options: [
            ...
            { value: 'some', label: 'Some Utilities Included' },
